...
- {{ page.date | date_to_string: "ordinal", "US" }} Originally published on [{{ site.url }}]({{ site.url }}) with uid {{ page.uid }}[^note]

### Footnotes

[^note]: Immediately filed in `_archive` as it was fun to reminisce, but nothing I want to publish. But also all mostly public information.
